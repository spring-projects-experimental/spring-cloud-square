...
An interceptor is added to the `OkHttpClient` created by autoconfiguration to resolve the scheme, host and port from Spring Cloud LoadBalancer and rewrite the url.
